...
%
\Title{Linking amino acid sequences to sources and
	fates of organic matter in aquatic systems}
\Author{Megan Duffy}
\Year{2021}
\Program{School of Oceanography}

\Chair{Rick Keil}{Dr.}{School of Oceanography}
\Signature{Jeff Richey}
\Signature{Gabrielle Rocap}
\Signature{Anitra Ingalls}
...
% ----- dedication
%
\dedication{\begin{center}for George\end{center}}
